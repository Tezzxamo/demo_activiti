...
public class ProcessInstanceManager {
    ...
    public void createProcessInstance(String processDefinitionName, String businessKey) {
        ...
        ActivitiUtil.instance().getRuntimeService().startProcessInstanceByKey(processDefinitionName, businessKey);
    }
    ...
    public void deleteProcessInstance(String processInstanceId, String reason) {
        ...
        ActivitiUtil.instance().getRuntimeService().deleteProcessInstance(processInstanceId, reason);
    }
    ...
    public void clearAllProcessInstances() {
        ...
        ActivitiUtil.instance().getRuntimeService().createProcessInstanceQuery()
                .list()
                .forEach(processInstance -> ActivitiUtil.instance().getRuntimeService().deleteProcessInstance(processInstance.getId(), "清空所有的流程实例"));
    }
    ...
    public void clearAllProcessInstancesByProcessDefinitionName(String processDefinitionName) {
        ...
        ActivitiUtil.instance().getRuntimeService().createProcessInstanceQuery()
                ...
                .list()
                .forEach(processInstance -> ActivitiUtil.instance().getRuntimeService().deleteProcessInstance(processInstance.getId(), "清空所有" + processDefinitionName + "的流程实例"));
    }
    ...
    public void completeProcessInstance(String processInstanceId, String username) {
        VerificationUtils.checkProcessInstanceById(processInstanceId);
        Task task = ActivitiUtil.instance().getTaskService().createTaskQuery()
    ...
    public void claimProcessInstance(String processInstanceId, String username) {
        ...
        Task task = ActivitiUtil.instance().getTaskService().createTaskQuery()
                .processInstanceId(processInstanceId)
                .singleResult();
        ActivitiUtil.instance().getTaskService().claim(task.getId(), username);
    }
    ...
    public void mandatoryClaimProcessInstance(String processInstanceId, String username) {
        ...
        Task task = ActivitiUtil.instance().getTaskService().createTaskQuery()
                .processInstanceId(processInstanceId)
                .singleResult();
        ActivitiUtil.instance().getTaskService().setAssignee(task.getId(), username);
    }
    ...
    public Collection<ProcessInstance> getProcInstancesByProDefName(String processDefinitionName) {
        VerificationUtils.checkProcessDefinitionByName(processDefinitionName);
        return ActivitiUtil.instance().getRuntimeService().createProcessInstanceQuery()
                .processDefinitionName(processDefinitionName)
                .list();
    }
    ...
    public ProcessInstance getProcInstanceByProDefNameAndBusinessKey(String processDefinitionName, String businessKey) {
        VerificationUtils.checkProcessDefinitionByName(processDefinitionName);
        ProcessInstance processInstance = ActivitiUtil.instance().getRuntimeService().createProcessInstanceQuery()
                .processDefinitionName(processDefinitionName)
    ...
    public List<Execution> getRunningActivityInstance(String processInstanceId) {
        ...
        return ActivitiUtil.instance().getRuntimeService().createExecutionQuery()
                .processInstanceId(processInstanceId)
                .list();
    }
